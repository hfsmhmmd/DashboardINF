  ...
  return (
    <div className=" card w-72 bg-white shadow-xl rounded-xl ">
      ...
      <div className="h-2/5   flex flex-row items-center justify-center">
        <div className="bg-green-400 h-4/5 w-4/5 rounded-xl flex flex-col justify-center items-center">
      ...
      <div className=" card-body flex flex-col justify-between ">
        <div className="bg-white flex flex-row justify-center">
          <h2 className="card-title"> Traffic </h2>
        </div>
        {/* <p>If a dog chews shoes whose shoes does he choose?</p> */}
        <div className="flex flex-row justify-between h-2/5 ">
          <div className="rounded-md  bg-green-400 rounded-md w-2/5 flex flex-col justify-evenly">
...
export default CallConnectedCard;
