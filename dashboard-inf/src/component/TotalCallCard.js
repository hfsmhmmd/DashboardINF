  ...
  return (
    <div className="card w-72 bg-white shadow-xl rounded-xl ">
      ...
      <div className="h-2/5   flex flex-row items-center justify-center">
        <div className="bg-blue-400 h-4/5 w-4/5 rounded-xl flex flex-col justify-center items-center">
      ...
      <div className=" card-body flex flex-col justify-between ">
        ...
        <div className="flex flex-row justify-between h-2/5 ">
          <div className="rounded-md  bg-blue-400 rounded-md w-2/5 flex flex-col justify-evenly">
